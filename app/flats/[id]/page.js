export default function FlatDetailsPage({ params }) {
  ...
  <div className="flat-details-box">
    ...
    <section className="flat-description">
      ...
      <p>
        This sunny 3-bedroom home is perfect for someone who loves peace and a
        good community vibe. Close to shops, buses, and parks.
      </p>
    </section>
    ...
    <div className="button-container">
      <button
        ...
        aria-label="Contact the flat owner"
      >
        Contact Flat Owner
      </button>
    </div>
